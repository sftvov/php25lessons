...
--
-- Хост: 127.0.0.1
-- Время создания: Окт 16 2019 г., 13:33
...
(9, 3, 'Что он делает в Скульптуре?', 13, '2019-10-16 11:31:37'),
(10, 4, 'Картинка не по адресу...', 13, '2019-10-16 11:32:13');
...
(13, '201910161247.jpg', 'Сгоревший светодиод', '', 4, 5, '2019-10-16 10:47:56');
...
(3, 'jocker', '$2y$10$azYrgZJkKyDIiUSmyomcyuyt9lQxJl..QDFpPUFFSW2QE/YSLjAse', '', '', '', 1, 1, 0),
(4, 'timid', '$2y$10$BpvwCXBSDsI9KnGOJ.swTOHcudi8LeL9Y8LUkUNkuCml7TYsue7RG', 'user@mail.server.ru', 'Very', 'timid', 1, 1, 0),
(5, 'timid2', '$2y$10$lnFoO/Hr0Tz79IKGoc9RZOe5tnCd6q58VcpJ562kNxEE2t8OeF/Km', 'user@mail.server.ru', '99', '00', 1, 0, 0);
